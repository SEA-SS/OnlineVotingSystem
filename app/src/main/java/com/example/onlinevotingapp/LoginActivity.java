...
//        }
        ...
        btnECA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email.equals("admin@gov.in") && password.equals("admin123")){
                    curUserType = "eca";
                                        ...
                                        subDbRef.addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                ...
                                                if(snapshot.hasChild("hasSubmitted")){
                                                    ...
                                                    }else startActivity(new Intent(getApplicationContext(), com.example.onlinevotingapp.MainActivity.class));
                                                }else startActivity(new Intent(getApplicationContext(), com.example.onlinevotingapp.MainActivity.class));
