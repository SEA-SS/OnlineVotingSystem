        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fName.trim().equals("")){
                    ...
                    dbRef.child("user-data").child(uid).setValue(curUser, new DatabaseReference.CompletionListener() {
                        @Override
                        public void onComplete(@NonNull DatabaseError error, @NonNull DatabaseReference ref) {
                            if (error != null) {
                                Toast.makeText(getApplicationContext(), "Submission failed: " + error.getMessage(), Toast.LENGTH_LONG).show();
                            } else {
